...
public class EmailManager {
    ...
    public Boolean approveSellerNotification(Seller seller, String fromEmailAddress, String toEmailAddress)
    {
        String emailBody = "";
        
        emailBody += "We have approve you to be a partner of Tailer(ED).";
        ...
        try 
        {
            ...
            if (msg != null)
            {
                ...
                String subject = "Welcome to Tailerd. " + seller.getFirstName() + " " + seller.getLastName();
